...
if (isset($_POST['delete'])) {
  ...
  $sql =  "UPDATE courses SET status = 0 WHERE id = $postId ";
...
if (isset($id)) {
  $postQuery = "SELECT * FROM courses where status = 1";
...
$analyzerDataQuery = "SELECT * FROM courses   ORDER BY inserted_date DESC";
...
<body>
  <div class="body_wrapper">
    <div class="center">
      ...
      <div class="backgro">
        <center>
          <h2 style="color: black;font-size: 20px;padding-top: 15px;"><strong>manage Courses</strong></h2>
        </center><br>
      </div>

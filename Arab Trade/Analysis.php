...
<body>
  <div class="body_wrapper">
    <div class="center">
      ...
      <div class="backgro">
        <center>
          <h2 style="color: white;font-size: 20px;"><strong>ANALYSIS</strong></h2>
        </center><br>
      </div>

      <div class="container">
        <?php if (isset($_SESSION['type']) && $_SESSION['type'] == 'anlyzer'): ?>
          <a href="addpost.php" class="btn btn-danger" style="font-weight:bold; letter-spacing: 1px;">
            Manage Analysis
          </a>
        <?php endif; ?>
        <hr>
        ...
        <div class="news-grid">
          <?php while ($row = $analyzerPdoObject->fetch(PDO::FETCH_ASSOC)): ?>
            <a href="ViewPost.php?id=<?= $row['id'] ?>" class="news-story">
